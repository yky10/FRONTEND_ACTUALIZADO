...
const Cocina = () => {
    ...
    useEffect(() => {
        const fetchOrdenes = async () => {
            try {
                const response = await axios.get("http://backendlogin-production-8d38.up.railway.app/orden/ordenes-preparando");
    ...
    const marcarComoListo = async (ordenId) => {
        try {
            const response = await axios.post(`http://backendlogin-production-8d38.up.railway.app/orden/responder-orden/${ordenId}`);
