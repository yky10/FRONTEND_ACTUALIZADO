...
function Categoriaplato() {
    ...
    const guardar = async () => {
        try {
            await Axios.post("http://backendlogin-production-8d38.up.railway.app/categoria/guardar", { nombre });
            listarCategorias();
            limpiarCampos();
            Swal.fire({
    ...
    const actualizar = async () => {
        try {
            await Axios.put("http://backendlogin-production-8d38.up.railway.app/categoria/actualizar", { id, nombre });
            listarCategorias();
            limpiarCampos();
            Swal.fire({
    ...
    const eliminarCategoria = async (val) => {
        ...
        if (result.isConfirmed) {
            try {
                await Axios.delete(`http://backendlogin-production-8d38.up.railway.app/categoria/eliminar/${val.id}`);
                listarCategorias();
                limpiarCampos();
                Swal.fire({
                    title: "Eliminado!",
