...
function Cliente() { 
    ...
    const addCliente = () => { 
        Axios.post("http://backendlogin-production-8d38.up.railway.app/cliente/guardar", { 
    ...
    const updateCliente = () => { 
        Axios.put("http://backendlogin-production-8d38.up.railway.app/cliente/actualizar", { 
            id: id, 
            nit_cliente: nitCliente, 
            nombre: nombre, 
            apellido: apellido, 
    ...
    const getClientes = () => { Axios.get("http://backendlogin-production-8d38.up.railway.app/cliente/listar").then((response) => { setClienteList(response.data); }); }; 
