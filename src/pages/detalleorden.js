...
function DetalleOrden() {
    ...
    const obtenerDetallesOrden = async () => {
        try {
            const response = await fetch('http://backendlogin-production-8d38.up.railway.app/detalle_orden/listar');
    ...
    const obtenerOrdenes = async () => {
        try {
            const response = await fetch('http://backendlogin-production-8d38.up.railway.app/orden/listar');
            const data = await response.json();
            setOrdenes(data);
        } catch (error) {
    ...
    const obtenerPlatillos = async () => {
        try {
            const response = await fetch('http://backendlogin-production-8d38.up.railway.app/platillos/listar');
            const data = await response.json();
            setPlatillos(data);
        } catch (error) {
    ...
    const agregarDetalleOrden = async () => {
        try {
            await Axios.post("http://backendlogin-production-8d38.up.railway.app/detalle_orden/guardar", {
                orden_id: ordenId,
    ...
    const actualizarDetalleOrden = async () => {
        try {
            await Axios.put("http://backendlogin-production-8d38.up.railway.app/detalle_orden/actualizar", {
                orden_id: ordenId,
                platillo_id: platilloId,
                cantidad: cantidad,
            });
    ...
    const eliminarDetalleOrden = async (id) => {
        try {
            await Axios.delete(`http://backendlogin-production-8d38.up.railway.app/detalle_orden/eliminar/${id}`);
            await obtenerDetallesOrden();
            Swal.fire({
