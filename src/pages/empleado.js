...
function Empleado() {
  ...
  const add = () => {
    Axios.post("http://backendlogin-production-8d38.up.railway.app/create", {
  ...
  const update = () => {
    Axios.put("http://backendlogin-production-8d38.up.railway.app/update", {
      id: id,
      primer_nombre: primerNombre,
      segundo_nombre: segundoNombre,
      primer_apellido: primerApellido,
  ...
  const deletepersona = (val) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Axios.delete(`http://backendlogin-production-8d38.up.railway.app/delete/${val.id}`).then(() => {
          getPersona();
          limpiarcampos();
          Swal.fire({
            title: "Eliminado!",
  ...
  const getPersona = () => {
    Axios.get("http://backendlogin-production-8d38.up.railway.app/obtenerlistapersonas").then((response) => {
