...
useEffect(() => {
    ...
    const obtenerCategorias = async () => {
        try {
            const response = await axios.get('http://backendlogin-production-8d38.up.railway.app/categoria/listar');
    ...
    const obtenerMesas = async () => {
        try {
            const response = await axios.get('http://backendlogin-production-8d38.up.railway.app/mesas/listar');
    ...
    const obtenerPlatillos = async (categoriaId) => {
        try {
            const response = await axios.get('http://backendlogin-production-8d38.up.railway.app/platillos/listar');
    ...
    const addOrden = async () => {
        ...
        try {
            const response = await axios.post("http://backendlogin-production-8d38.up.railway.app/orden/guardar", {
    ...
    const confirmarPlatillo = async (platilloId) => {
        ...
        if (platillo) {
            try {
                ...
                const response = await axios.post("http://backendlogin-production-8d38.up.railway.app/detalle_orden/guardar", {
                    orden_id: ordenId,
    ...
    const eliminarPlatillo = async (platilloId) => {
        ...
        try {
            const response = await axios.delete(`http://backendlogin-production-8d38.up.railway.app/detalle_orden/eliminar/${ordenId}/${platilloId}`, {
...
const enviarOrden = async (ordenId) => {
    try {
        const response = await axios.post(`http://backendlogin-production-8d38.up.railway.app/orden/enviar-orden/${ordenId}`); 
