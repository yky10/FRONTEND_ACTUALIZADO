...
function Mesa() {
    ...
    const guardarMesa = async () => {
        try {
            await Axios.post("http://backendlogin-production-8d38.up.railway.app/mesas/guardar", {
                numero: numero,
    ...
    const actualizarMesa = async () => {
        try {
            await Axios.put("http://backendlogin-production-8d38.up.railway.app/mesas/actualizar", {
                id: id,
                numero: numero,
                capacidad_max: capacidadMax
            });
