...
function Orden() {
    ...
    useEffect(() => {
        const obtenerMesas = async () => {
            try {
                const response = await fetch('http://backendlogin-production-8d38.up.railway.app/mesas/listar');
                const data = await response.json();
                setMesas(data);
            } catch (error) {
    ...
    const updateOrden = async () => {
        try {
            await Axios.put("http://backendlogin-production-8d38.up.railway.app/orden/actualizar", {
                id_orden: idOrden,
                id_usuario: idUsuario,
                mesa_id: mesaId,
                fecha_orden: fechaOrden,
    ...
    const listaOrdenes = async () => {
        try {
            const response = await Axios.get("http://backendlogin-production-8d38.up.railway.app/orden/listar");
