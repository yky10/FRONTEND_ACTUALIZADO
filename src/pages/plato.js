...
function Platillos() {
    ...
    useEffect(() => {
        const obtenerCategorias = async () => {
            try {
                const response = await fetch('http://backendlogin-production-8d38.up.railway.app/categoria/listar');
    ...
    const guardarPlatillo = async () => {
        try {
            ...
            await Axios.post("http://backendlogin-production-8d38.up.railway.app/platillos/guardar", formData, {
                headers: {
    ...
    const actualizarPlatillo = async () => {
        try {
            ...
            await Axios.put("http://backendlogin-production-8d38.up.railway.app/platillos/actualizar", formData, {
                headers: {
                    "Content-Type": "multipart/form-data",
                },
            });
