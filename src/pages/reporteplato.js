...
function ReportePlatos() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const platosResponse = await Axios.get("http://backendlogin-production-8d38.up.railway.app/platillos/listar");
                setPlatos(platosResponse.data);
                const categoriasResponse = await Axios.get("http://backendlogin-production-8d38.up.railway.app/categoria/listar");
