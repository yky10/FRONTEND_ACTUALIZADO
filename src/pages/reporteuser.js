...
function ReporteUser() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const personasResponse = await Axios.get("http://backendlogin-production-8d38.up.railway.app/obtenerlistapersonas");
                setPersonas(personasResponse.data);
                const rolesResponse = await Axios.get("http://backendlogin-production-8d38.up.railway.app/obtenerrol");
                setRoles(rolesResponse.data);
                const estadosResponse = await Axios.get("http://backendlogin-production-8d38.up.railway.app/obtenerestado");
    ...
    const getUsuario = async () => {
        try {
            const response = await Axios.get("http://backendlogin-production-8d38.up.railway.app/obteneruser");
