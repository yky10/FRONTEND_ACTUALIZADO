...
useEffect(() => {
    ...
    Axios.get("http://backendlogin-production-8d38.up.railway.app/obtenerpersona")
        .then((response) => {
...
const obtenerPersonas = async () => {
  try {
      const response = await fetch('http://backendlogin-production-8d38.up.railway.app/obtenerpersona');
...
const obtenerEstado = async () => {
  try {
      const response = await fetch('http://backendlogin-production-8d38.up.railway.app/obtenerestado');
      const data = await response.json();
      setEstados(data);
  } catch (error) {
...
const obtenerRol = async () => {
  try {
      const response = await fetch('http://backendlogin-production-8d38.up.railway.app/obtenerrol');
      const data = await response.json();
      setRoles(data);
  } catch (error) {
...
const addUser = () => {
    Axios.post("http://backendlogin-production-8d38.up.railway.app/create-usuario", {
  ...
  const updateUser = () => {
    ...
    Axios.put("http://backendlogin-production-8d38.up.railway.app/updateuser", {
      id_usuario: id,
      id_persona: idPersona,
      rol_id: idRol,
      estado_id: idEstado,
  ...
  useEffect(() => {
    ...
    // Fetch roles
    Axios.get("http://backendlogin-production-8d38.up.railway.app/obtenerrol")
        .then(response => setRoles(response.data))
        .catch(error => console.error("Error fetching roles:", error));

    // Fetch states
    Axios.get("http://backendlogin-production-8d38.up.railway.app/obtenerestado")
  ...
  const getUsuario = () => {
    Axios.get("http://backendlogin-production-8d38.up.railway.app/obteneruser").then((response) => {
  ...
  getUsuario();
    ...
    const fetchPersonas = async () => {
        try {
            const response = await Axios.get("http://backendlogin-production-8d38.up.railway.app/obtenerPersona");
            setPersonas(response.data);
        } catch (error) {
